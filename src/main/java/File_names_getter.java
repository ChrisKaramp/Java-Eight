...
public class File_names_getter {

    // define proper structure to put file names
    private List<String> fileNames = new ArrayList<>();

    // constructor
    File_names_getter(String givenFolder, String fileWildCard) {
        ...
        FileFilter filesOfAnExtension = new FileFilter() {
            public boolean accept(File file) {
                if (file.getName().toLowerCase().endsWith(fileWildCard.toLowerCase())) {
                    return true;
                }
                return false;
            }
