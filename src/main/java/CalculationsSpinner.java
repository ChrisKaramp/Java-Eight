...
/**
 * Creates spinner that calculates (sub)totals automatically by changing its value.
 */
public class CalculationsSpinner extends JSpinner {
    /**
    ...
    public CalculationsSpinner(int gridColumns, ArrayBasedPanel thisPanel, ArrayList<ArrayBasedPanel> panelsToBeControlled) {
        ...
        this.addChangeListener((ChangeEvent e) -> {
            ...
            if (gridColumns == 2) {
                ...
                Integer total = 0;
                for (CalculationsSpinner spinner2 : thisPanel.getListeningSpinnersToBeCreated()) {
