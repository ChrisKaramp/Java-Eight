...
mvn clean
mvn package
java -jar target\pfad_j8-1.1.jar
...
23.	Mass_update.java
24.	Constants.java
25.	File_names_getter.java
26.	Comparison_combobox.java
27.	Comparison_panel_using_array.java
28.	Country_comparison_window_model.java
...
25.	File_names_getter.java -> κλάση λήψης ονομάτων αρχείων από φάκελο
Παίρνει τα ονόματα όλων τον csv αρχείων από το φάκελο δεδομένων και τα τοποθετεί σε μία δομή δεδομένων κατάλληλη για χρήση από την κλάση Comparison_combobox.java η οποία περιγράφεται παρακάτω.

26.	Comparison_combobox.java -> κλάση επιλογής χώρας.
Υλοποιεί μέσω στιγμιοτύπου ένα μενού που περιέχει τα ονόματα αρχείων κάθε διαθέσιμης χώρας προς σύγκριση με την default. Λαμβάνει αυτά τα δεδομένα από την προηγούμενη κλάση File_names_getter.java. Σε κάθε επιλογή χώρας δημιουργεί το αντίστοιχο παράθυρο συγκρίσεων για το τρέχον επιλεγμένο έτος.

27.	Comparison_panel_using_array.java -> 
Υλοποιεί μέσω στιγμιοτύπου ένα panel για κάθε επιλεγμένη χώρα, το οποίο θα δημιουργηθεί μέσω αλγορίθμου και θα τοποθετηθεί σε στιγμιότυπο κλάσης Country_comparison_window_model. Τα δεδομένα λαμβάνει από το αντίστοιχο αρχείο δεδομένων csv της χώρας.

28.	Country_comparison_window_model.java -> κλάση σύγκρισης χωρών.
Υλοποιεί μέσω στιγμιοτύπου δύο παράθυρα αντίστοιχα με τα αρχικά, το καθένα με δύο panel τύπου Comparison_panel_using_array.java για σύγκριση δεδομένων αρχείων μεταξύ δύο χωρών. Τα δεδομένα εμφανίζονται σε labels με χρήση κατάλληλα προσαρμοσμένου αλγορίθμου.
